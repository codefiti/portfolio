    ...
    <>
      <div id="page-wrapper">
        ...
        <div id="title" className="centered flex-col-aligned">
          <span className="mt">CodeFiti</span>
        </div>

        <i id="icon">
          <img className="rocket" src="" alt="" srcSet="./favicon.png" />
        </i>
        <p id="description" className="fancy centered"></p>
      </div>
        ...
        <section className="team">
          <div className="grid">
            ...
            >
              ...
              <p>
                Pioneering digital solutions tailored to modern challenges,
                utilizing cutting-edge technology and creative problem-solving
                approaches.
              </p>
            ...
            >
              ...
              <p>
                Streamlining operations with advanced automation tools,
                enhancing productivity and operational efficiency for
                businesses.
              </p>
              <div className="shine"></div>
              <div className="background">
            ...
            >
              ...
              <p>
                Providing expert cyber security guidance and solutions to
                protect digital assets and ensure data integrity.
              </p>
              <div className="shine"></div>
              <div className="background">
                <div className="tiles">
            ...
            >
              ...
              <p>
                Crafting bespoke digital marketing plans to boost online
                presence, engage audiences, and drive business growth.
              </p>
              <div className="shine"></div>
              <div className="background">
                <div className="tiles">
            ...
            >
              ...
              <p>
                Building dynamic, user-friendly websites integrated with
                analytics tools for insightful data-driven decisions.
              </p>
              <div className="shine"></div>
              <div className="background">
                <div className="tiles">
            ...
            >
              ...
              <p>
                ...
                tailored to meet specific business needs and objectives.
              </p>
              <div className="shine"></div>
              <div className="background">
                <div className="tiles">
          ...
          <div className="grid">
            ...
            >
              <span className="images">
                <img
                  src="./resources/images/ken.jpg"
                  alt="Image 1"
                  className="image1"
                />
                <img
                  src="./resources/images/nim.jpg"
                  alt="Image 2"
                  className="image2"
                />
              </span>
              ...
              <p className="mt">
                We are here to help you with any technical issues you may have.
            ...
            >
              <span className="images">
                <img
                  src="./resources/images/jimmy.jpg"
                  alt="Image 1"
                  className="image1"
                />
                <img
                  src="./resources/images/sherry.jpg"
                  alt="Image 2"
                  className="image2"
                />
              </span>
            ...
            >
              <span className="images">
                <img
                  src="./resources/images/kingb2.jpg"
                  alt="Image 1"
                  className="image1"
                />
                <img
                  src="./resources/images/purity.jpg"
                  alt="Image 2"
                  className="image2"
                />
              </span>
